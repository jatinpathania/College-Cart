...
const Clothings = () => {
    ...
    const [clothingsItems, setClothingsItems] = useState([]);
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const filteredClothingItem = response.data.products.filter((item) =>
                    item.category === 'Clothing')
                setClothingsItems(filteredClothingItem);
                setLoading(false)
                // console.log(filteredClothingItem)
            } catch (error) {
